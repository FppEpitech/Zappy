...
Gui::ServerParser::ServerParser()
{
    ...
    _functionsMap["ebo"] = &_parseCommandEBO;
...
std::vector<std::string> Gui::ServerParser::_parseCommandEBO(const std::string& command)
{
    std::vector<std::string> arguments;
    std::istringstream stream(command);
    std::string none;
...
std::vector<std::string> Gui::ServerParser::_parseCommandEDI(const std::string& command)
{
    std::vector<std::string> arguments;
    std::istringstream stream(command);
    std::string none;
...
std::vector<std::string> Gui::ServerParser::_parseCommandSGT(const std::string& command)
{
    std::vector<std::string> arguments;
    std::istringstream stream(command);
    std::string none;
...
std::vector<std::string> Gui::ServerParser::_parseCommandSST(const std::string& command)
{
    std::vector<std::string> arguments;
    std::istringstream stream(command);
    std::string none;
...
std::vector<std::string> Gui::ServerParser::_parseCommandSUC(const std::string& command)
{
    std::vector<std::string> arguments;
    std::istringstream stream(command);
    std::string none, team;
