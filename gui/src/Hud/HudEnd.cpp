...
void Gui::HudEnd::display()
{
    ...
    std::string advice = "Press 'ESC' to quit the game";
    ...
    DrawText(advice.c_str(), WINDOW_WIDTH / 2 - MeasureText(advice.c_str(), END_HUD_ADVICE_TEXT_SIZE) / 2, WINDOW_HEIGHT / 2 + 50, END_HUD_ADVICE_TEXT_SIZE, WHITE);
}
