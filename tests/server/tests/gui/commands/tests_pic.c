...
Test(pic_command, basic_test)
{
    ...
    cr_assert_str_eq(gui.list_messages->first->data.message, "pic 1 1 2 1 2\n");
}

Test(pic_command, basic_test_2)
{
    app_t app;
    gui_t gui;
    node_data_t gui_data;
    ...
    pic_command(&app, list_ai);
    cr_assert_str_eq(gui.list_messages->first->data.message, "pic 1 1 6 1 2\n");}

Test(pic_command, multiple_gui_test)
{
    app_t app;
    gui_t gui;
    node_data_t gui_data;
